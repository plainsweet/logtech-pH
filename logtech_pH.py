...
if test == "Home":
    ...
    with tab1:
        ...
        if original_list == asamkuat :
            st.write("Jenis larutan yang dipilih adalah **{Asam Kuat}**")
...
if test == "Contact Us":
    ...
    contact_form = """
    <form action="https://formsubmit.co/381830fc2780e25bfd8ec1ef55bfaf03" method="POST">
